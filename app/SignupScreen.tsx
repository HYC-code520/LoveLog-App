...
export default function SignupScreen({ navigation }) {
  ...
  const handleSignup = async () => {
    ...
    setLoading(true);
    try {
      const response = await fetch(`${API_BASE_URL}/signup`, {  // 🔥 Replace with your actual backend URL
        method: "POST",
      ...
      if (response.ok) {
        await SecureStore.setItemAsync("authToken", data.access_token);  // ✅ Store JWT
